...
access_watch = WindowsAccessWatch(file_path="source\main.py")
print((access_watch.get_last_access_time()))
sid = access_watch.get_owner_sid()
print(sid)
print(access_watch.sid_to_username_info(sid=sid))